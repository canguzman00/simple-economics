            ...
            {[
              ...
              return (
                <a key={item.href} href={item.href}
                  style={{ fontSize: '12px', color: item.href.includes('company') ? '#F8FAFC' : '#94A3B8', textDecoration: 'none', padding: '6px 12px', borderRadius: '6px', background: item.href.includes('company') ? '#1B4FD8' : 'transparent' }}>
                  {item.label}
                </a>
              )
            })}
