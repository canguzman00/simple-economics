      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 24px' }}>
        <div style={{ width: '100%', maxWidth: '400px' }}>
          ...
          <button
            ...
            disabled={loading}
            style={{ width: '100%', background: loading ? '#333' : '#1B4FD8', border: 'none', color: '#fff', fontSize: '12px', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', padding: '14px', cursor: loading ? 'not-allowed' : 'pointer', fontFamily: 'Unbounded, sans-serif', marginBottom: '20px' }}>
