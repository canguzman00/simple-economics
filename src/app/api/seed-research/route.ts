...
const RESEARCH_PAPERS = [
  ...
  { title: "Income Inequality in America: New Evidence from Tax Records", summary: "The top 1% of earners now capture 20% of all income in the United States, the highest share since the 1920s. The research finds that tax policy changes since 2000 have contributed significantly to this concentration, while declining union membership has reduced bargaining power for workers.", source: "Quarterly Journal of Economics", url: "https://academic.oup.com/qje/issue", year: 2024, pillar: "DEVELOPMENT_POLICY" },
