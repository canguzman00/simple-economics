    ...
    <div style={{ background: "#F8FAFC", fontFamily: "Inter, sans-serif", minHeight: "100vh" }}>
      ...
      <nav style={{ background: "#1E293B", borderBottom: "1px solid #334155", position: "sticky", top: 0, zIndex: 40 }}>
        <div style={{ maxWidth: "72rem", margin: "0 auto", padding: "0 1.5rem", height: "3.5rem", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            <Link href="/signin" style={{ fontSize: "12px", color: "#94A3B8", textDecoration: "none" }}>Sign In</Link>
            <Link href="/signup" style={{ fontSize: "12px", fontWeight: 600, padding: "8px 16px", borderRadius: "8px", background: "#F43F5E", color: "#fff", textDecoration: "none" }}>
              Get Started
            </Link>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12 py-16 md:min-h-[calc(100vh-3.5rem)]">
          ...
          <div>
            ...
            <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
              <Link href="/signup" style={{ fontSize: "14px", fontWeight: 600, padding: "14px 28px", borderRadius: "10px", background: "#F43F5E", color: "#fff", textDecoration: "none" }}>
                Get Started Free
              </Link>
      ...
      <div style={{ background: "#1E293B", padding: "80px 0" }}>
        <div style={{ maxWidth: "72rem", margin: "0 auto", padding: "0 1.5rem" }}>
          ...
          <Link href="/signup" style={{ fontSize: "14px", fontWeight: 600, padding: "14px 32px", borderRadius: "10px", background: "#F43F5E", color: "#fff", textDecoration: "none", display: "inline-block" }}>
            Get Started Free
          </Link>
        </div>
      </div>
