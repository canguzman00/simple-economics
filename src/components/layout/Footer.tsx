export function Footer() {
  return (
    <footer className="border-t border-[#2C2417] mt-auto">
      <div className="mx-auto max-w-4xl px-6 py-10 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
        ...
        {/* Disclaimer */}
        <p className="font-sans text-xs text-[#4A3D2A] max-w-xs sm:text-right leading-relaxed">
...
function SocialLink({ href, label, icon }: { href: string; label: string; icon: React.ReactNode }) {
  return (
    <a
      ...
      aria-label={label}
      className="text-[#4A3D2A] hover:text-[#C49A52] transition-colors"
    >
      {icon}
    </a>
  );
